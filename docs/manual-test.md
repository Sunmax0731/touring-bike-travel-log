...
`D:\AI\AndroidApp\touring-bike-travel-log`
...
- `public/index.html`
- `dist/touring-bike-travel-log-docs.zip`

## セットアップ手順

```powershell
cd D:\AI\AndroidApp\touring-bike-travel-log
npm test
npm start
```
...
4. `dist/touring-bike-travel-log-docs.zip` を展開し、README、導入手順、ユーザーガイド、QCDS、release evidence が含まれることを確認する。
